...
### QA Automation Engineer | Remote-Ready | Playwright · Selenium · Cucumber · BDD
...
**Tech:** Java · Selenium WebDriver · Cucumber · TestNG · Maven
...
**Tech:** Java · Selenium · Cucumber · TestNG · Sauce Labs · Maven
...
|------------|---------|
| Agile Scrum | Sprint Planning, Daily Scrum, Retrospectives |
| BDD | Gherkin feature files, Given/When/Then |
| SDLC / STLC | Full lifecycle involvement |
| Waterfall | Documentation-driven testing |
| POM | Page Object Model for maintainable automation |
...
*If you are looking for a detail-oriented QA Automation Engineer who can build frameworks from scratch, write clean BDD scenarios, and deliver reliable test coverage — let's connect!*
